...
AllBeekeeperForm::AllBeekeeperForm(QWidget *parent) : QWidget(parent) {
    ...
    connect(editDataButton, &QPushButton::clicked, this, &AllBeekeeperForm::onEditButtonClicked);
    connect(addDataButton, &QPushButton::clicked, this, &AllBeekeeperForm::onAddButtonClicked);
    connect(deleteDataButton, &QPushButton::clicked, this, &AllBeekeeperForm::onDeleteButtonClicked);
    connect(backButton, &QPushButton::clicked, this, &AllBeekeeperForm::onBackButtonClicked);
...
void AllBeekeeperForm::onAddButtonClicked() {
    ...
    if (query.next()) {
        ...
        showMessageBox("Error", "Failed to get the maximum ID_Beekeeper!", QMessageBox::Warning);
    }
}
...
void AllBeekeeperForm::loadBeekeepersData() {
    ...
    if (model->rowCount() == 0) {
        showMessageBox("Error", "No beekeepers found!", QMessageBox::Warning);
    }
...
void AllBeekeeperForm::showMessageBox(const QString &title, const QString &message, QMessageBox::Icon icon) {
